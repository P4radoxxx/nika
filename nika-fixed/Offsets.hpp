...
constexpr long OFFSET_GRAPPLEACTIVED = 0x1e38;		      //
constexpr long OFFSET_GRAPPLE = 0x1e38;		              //
constexpr long OFFSET_GRAPPLEATTACHED = 0x0048;		      //
    ...
    constexpr long OOFFSET_WALL_RUN_CLEAR_TIME = 0x3588;              //[Buttons]->m_wallRunClearTime
    ...
    constexpr long OFF_LAST_AIMEDAT_TIME = 0x198d + 0x3;    //[RecvTable.DT_BaseCombatCharacter]->m_hudInfo_visibilityTestAlwaysPasses + 0x3 + 0x8
