    ...
    constexpr long OFFSET_IN_FORWARD = 0x073e1ca8; //[Buttons]->in_forward o
    constexpr long OFFSET_TRAVERSAL_START_TIME = 0x2ad0; //[Buttons]->m_traversalStartTime o
    constexpr long OFFSET_TRAVERSAL_PROGRESS = 0x2acc; //[Buttons]->m_traversalProgress
    constexpr long OFFSET_WALL_RUN_START_TIME = 0x355c; //[Buttons]->m_wallRunStartTime o
    constexpr long OFFSET_WALL_RUN_CLEAR_TIME = 0x3560; //[Buttons]->m_wallRunClearTime o
    ...
    constexpr long OFFSET_AMMO = 0x1560; // m_ammoInClip
    constexpr long OFF_GRENADE_HANDLE = 0x1924; //[RecvTable.DT_Player]->m_latestNonOffhandWeapons o
    constexpr long OFFSET_TIME_BASE = 0x2068; //m_currentFramePlayer.timeBase o
